...
SCHEMES_LIST = [
    ...
    {
        "id": "pm_daksh",
        "name": "PM-DAKSH (Skill Development)",
        "icon": "🛠️",
        "description": "Skill development for marginalized groups including SC, OBC, EBC, DNT, and Sanitation Workers.",
        "benefits": "Free training, stipends, and placement assistance.",
        "max_income": 300000,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["SC", "ST", "OBC", "EBC"],
        "required_documents": ["Caste Certificate", "Income Certificate", "Aadhaar Card"],
        "deadline": "Rolling",
    ...
    },
    {
        ...
        "icon": "✈️",
        "description": "Assistance for SC/ST students to pursue Master's or PhD abroad.",
        "benefits": "Full tuition fees, maintenance allowance, and airfare.",
        "max_income": 800000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["SC", "ST"],
        "required_documents": ["Admission Offer", "Caste Certificate", "Academic Records"],
        "deadline": "March 31",
    ...
    },
    {
        ...
        "eligible_categories": ["All"],
        "land_owned_required": True,
        "required_documents": ["Land Records", "Sowing Certificate", "Bank Passbook"],
        "deadline": "Seasonal",
    ...
    },
    {
        ...
        "benefits": "Up to 60% subsidy for solar water pumps.",
        "max_income": 1200000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Farmer"],
        "eligible_categories": ["All"],
        "land_owned_required": True,
        "required_documents": ["Land Ownership Proof", "Aadhaar Card", "Bank Details"],
        "deadline": "Open",
    ...
    },
    {
        ...
        "name": "e-Shram Card",
        "icon": "🗂️",
        "description": "National database of unorganized workers to facilitate social security benefits.",
        "benefits": "Accidental insurance of ₹2 Lakh and direct benefit transfers during disasters.",
        "max_income": 5000000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Manual Labor", "Daily Wager", "Artisan", "Domestic Worker"],
        "eligible_categories": ["All"],
        "required_documents": ["Aadhaar Card", "Mobile Linked to Aadhaar", "Bank Account"],
        "deadline": "Ongoing",
    ...
    },
    {
        ...
        "icon": "🛒",
        "description": "Enabling NFSA beneficiaries to lift their entitled foodgrains from any Fair Price Shop.",
        "benefits": "Portability of food security benefits across India.",
        "max_income": 300000,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["General (BPL)"],
    ...
    },
    {
        ...
        "icon": "👧",
        "description": "Campaign to generate awareness and improve the efficiency of welfare services for girls.",
        "benefits": "Educational support and social security incentives.",
        "max_income": 9999999,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["All"],
        "gender": "Female",
        "required_documents": ["Birth Certificate", "Ration Card"],
    ...
    },
    {
        ...
        "icon": "🤱",
        "description": "Reducing maternal and neonatal mortality by promoting institutional delivery among poor women.",
        "benefits": "Cash assistance for institutional delivery.",
        "max_income": 150000,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["SC", "ST", "General (BPL)"],
        "gender": "Female",
        "required_documents": ["BPL Card", "JSY Card", "Aadhaar Card"],
        "deadline": "Ongoing",
    ...
    },
    {
        ...
        "icon": "💉",
        "description": "Strengthening and re-energizing immunization coverage in India.",
        "benefits": "Full immunization of children and pregnant women.",
        "max_income": 9999999,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["All"],
        "required_documents": ["Vaccination Card", "Aadhaar"],
        "deadline": "Ongoing",
    ...
    {
        "id": "pm_devine",
        "name": "PM-DevINE (North East Development)",
        "icon": "🏔️",
        "description": "Funding infrastructure and social development projects in the North Eastern Region.",
        "benefits": "Large-scale infrastructure and livelihood development grants.",
        "max_income": 5000000,
        "eligible_states": ["Assam", "Arunachal Pradesh", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Sikkim", "Tripura"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["All"],
        "required_documents": ["Address Proof", "Inhabitant Certificate"],
        "deadline": "Project Based",
    ...
    },
    {
        ...
        "icon": "🏘️",
        "description": "Developing Gram Panchayats into model villages.",
        "benefits": "Improved local infrastructure, education, and sanitation facilities.",
        "max_income": 9999999,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["All"],
        "required_documents": ["Residential Proof"],
        "deadline": "Ongoing",
    ...
    },
    {
        ...
        "name": "Swachh Bharat Abhiyan Assistance",
        "icon": "🧹",
        "description": "Financial assistance for constructing household latrines in rural/urban areas.",
        "benefits": "Subsidy of ₹12,000 for individual toilet construction.",
        "max_income": 200000,
        "eligible_states": ["All"],
        "eligible_occupations": ["All"],
        "eligible_categories": ["All"],
        "required_documents": ["Aadhaar", "Bank Account", "Photo of Construction Site"],
        "deadline": "Ongoing",
    ...
    {
        "id": "pm_wani",
        "name": "PM-WANI (Public Wi-Fi)",
        "icon": "📶",
        "description": "Proliferation of Broadband through Public Wi-Fi Networks.",
        "benefits": "High-speed internet access in public spaces.",
        "max_income": 9999999,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student", "Entrepreneur", "All"],
        "eligible_categories": ["All"],
    ...
    },
    {
        ...
        "icon": "🏫",
        "description": "One-year program for students to gain practical knowledge and skills.",
        "benefits": "Stipend during training and professional certification.",
        "max_income": 1500000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student", "Unemployed"],
        "eligible_categories": ["All"],
        "required_documents": ["Degree/Diploma Certificate", "Aadhaar", "Bank Details"],
        "deadline": "Open",
    ...
    },
    {
        ...
        "icon": "🎒",
        "description": "Scholarship for students of class IX to XII to prevent dropouts.",
        "benefits": "Scholarship amount of ₹12,000 per annum.",
        "max_income": 350000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["All"],
        "required_documents": ["Academic Certificate", "Income Certificate", "Caste Certificate"],
        "deadline": "Nov 30",
    ...
    },
    {
        ...
        "icon": "📖",
        "description": "Scholarship for students belonging to minority communities (Muslim, Christian, Sikh, Buddhist, Parsi, Jain).",
        "benefits": "Tuition fees and maintenance allowance.",
        "max_income": 100000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["All"],
        "required_documents": ["Self-declaration of Minority Status", "Income Certificate", "Marksheet"],
        "deadline": "Sept 30",
        "apply_url": "https://scholarships.gov.in/",
        "category": "Education",
        "popularity": 79
    },
    {
        ...
        "icon": "🎓",
        "description": "Assistance for minority students to pursue higher education.",
        "benefits": "Course fees and maintenance allowance support.",
        "max_income": 200000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["All"],
        "required_documents": ["Minority Status Proof", "Institutional Certificate", "Income Certificate"],
        "deadline": "Dec 31",
        "apply_url": "https://scholarships.gov.in/",
        "category": "Education",
        "popularity": 80
    },
    {
        ...
        "icon": "🏆",
        "description": "Scholarship for professional and technical courses for minority students.",
        "benefits": "Financial assistance for professional/technical graduation/post-graduation.",
        "max_income": 250000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Student"],
        "eligible_categories": ["All"],
        "required_documents": ["Entrance Exam Result", "Income Proof", "Community Certificate"],
        "deadline": "Oct 31",
        "apply_url": "https://scholarships.gov.in/",
        "category": "Education",
        "popularity": 74
    ...
    {
        "id": "usttad_scheme",
        "name": "USTTAD (Minority Artisans)",
        "icon": "🏺",
        "description": "Upgrading the Skills and Training in Traditional Arts/Crafts for Development.",
        "benefits": "Capacity building and market linkage for traditional crafts.",
        "max_income": 450000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Artisan", "Craftsman"],
        "eligible_categories": ["All"],
        "required_documents": ["Minority Certificate", "Caste Certificate", "Aadhaar"],
        "deadline": "Rolling",
    ...
    },
    {
        ...
        "icon": "📑",
        "description": "Establishment of clear ownership of property in rural areas using drone technology.",
        "benefits": "Property Cards provided to rural owners for financial stability.",
        "max_income": 9999999,
        "eligible_states": ["All"],
        "eligible_occupations": ["Farmer", "All"],
        "eligible_categories": ["All"],
        "required_documents": ["Existing Land Papers", "Aadhaar"],
        "deadline": "Phase Wise",
    ...
    },
    {
        ...
        "icon": "🍂",
        "description": "Pension scheme for small and marginal farmers to lead a secure life after age 60.",
        "benefits": "Fixed monthly pension of ₹3,000 after attaining age 60.",
        "max_income": 300000,
        "eligible_states": ["All"],
        "eligible_occupations": ["Farmer"],
        "eligible_categories": ["All"],
